...
@interface QQRankViewController ()
...
@implementation QQRankViewController
...
- (void)loadNewTopics {
    ...
    [manager GET:QQRankURL(self.maxid) parameters:nil progress:^(NSProgress * _Nonnull downloadProgress) {
